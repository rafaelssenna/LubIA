    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0a0a0a] via-[#0f0f0f] to-[#0a0a0a]">
      ...
      <div className="p-6 space-y-6 animate-fade-in">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <div className="bg-gradient-to-br from-[#1a1a1a] to-[#141414] border border-[#2a2a2a] rounded-xl p-4 hover:border-purple-500/30 hover:shadow-lg hover:shadow-purple-500/5 transition-all duration-300">
            <div className="flex items-center gap-3">
              <div className="p-2.5 bg-purple-500/20 rounded-xl ring-1 ring-purple-500/20">
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {servicos.map((servico) => (
              <div
                key={servico.id}
                className={`bg-gradient-to-br from-[#1a1a1a] to-[#141414] border rounded-2xl p-6 transition-all duration-300 ${
                  servico.ativo
                    ? 'border-[#2a2a2a] hover:border-[#22c55e]/40 hover:shadow-lg hover:shadow-[#22c55e]/5'
          ...
          <div className="bg-gradient-to-br from-[#1a1a1a] to-[#141414] border border-[#2a2a2a] rounded-2xl w-full max-w-lg animate-fade-in shadow-2xl">
            <div className="p-6 border-b border-[#2a2a2a] flex items-center justify-between">
              ...
              <button
                ...
                className="p-2 hover:bg-[#2a2a2a] rounded-lg transition-all duration-200 text-[#94a3b8] hover:text-white"
              >
                <X size={20} />
              </button>
            </div>
            <div className="p-6 space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={2}
                  className="w-full bg-[#0f0f0f] border border-[#2a2a2a] rounded-xl px-4 py-3 text-white placeholder-[#6B7280] focus:outline-none focus:border-[#22c55e]/50 focus:ring-1 focus:ring-[#22c55e]/20 transition-all duration-200 resize-none"
                />
              </div>
            ...
            <div className="p-6 border-t border-[#2a2a2a] flex gap-3 justify-end">
              ...
              <button
                ...
                disabled={saving}
                className="px-6 py-3 bg-gradient-to-r from-[#22c55e] to-[#166534] rounded-xl text-white font-medium hover:shadow-lg hover:shadow-[#22c55e]/25 hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 disabled:opacity-50 disabled:hover:scale-100"
              >
          ...
          <div className="bg-gradient-to-br from-[#1a1a1a] to-[#141414] border border-[#2a2a2a] rounded-2xl w-full max-w-md animate-fade-in shadow-2xl">
            ...
            <div className="p-6">
              <div className="flex items-center gap-4 mb-4">
                <div className="p-3 bg-red-500/20 rounded-xl ring-1 ring-red-500/20">
