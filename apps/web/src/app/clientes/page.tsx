          ...
          <div className="group relative bg-[#f0f8ea] rounded-2xl p-5 border border-[#AADF94] hover:border-green-300 transition-all duration-300 hover:shadow-lg hover:shadow-[#22c55e]/5">
            ...
            <div className="relative flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-[#4D9F3F]">Total Clientes</p>
              </div>
            </div>
          </div>
          <div className="group relative bg-[#f0f8ea] rounded-2xl p-5 border border-[#AADF94] hover:border-blue-500/30 transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/5">
            ...
            <div className="relative flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-[#4D9F3F]">Total Veiculos</p>
              </div>
            </div>
          </div>
          <div className="group relative bg-[#f0f8ea] rounded-2xl p-5 border border-[#AADF94] hover:border-amber-500/30 transition-all duration-300 hover:shadow-lg hover:shadow-amber-500/5 hidden md:block">
            ...
            <div className="relative flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-[#4D9F3F]">Msgs Enviadas (Hoje)</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row gap-4 justify-between">
          <div className="relative flex-1 max-w-md">
            ...
            <input
              ...
              className="w-full bg-[#f0f8ea] border border-[#AADF94] rounded-xl pl-11 pr-4 py-3 text-sm text-[#1a3a12] placeholder-gray-500 focus:outline-none focus:border-[#22c55e]/50 focus:ring-1 focus:ring-[#22c55e]/20 transition-all duration-200"
            />
          </div>
          <button
            onClick={() => {
            ...
            className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-[#22c55e] to-[#166534] rounded-xl text-white font-medium hover:shadow-lg hover:shadow-green-100 transition-all duration-300 hover:scale-[1.02]"
          >
            <Plus size={18} />
            Novo Cliente
          </button>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-[#AADF94]">
                  <th className="text-left px-6 py-4 text-sm font-medium text-[#4D9F3F]">Cliente</th>
                  <th className="text-left px-6 py-4 text-sm font-medium text-[#4D9F3F]">Telefone</th>
                  <th className="text-left px-6 py-4 text-sm font-medium text-[#4D9F3F]">CPF</th>
                  <th className="text-center px-6 py-4 text-sm font-medium text-[#4D9F3F]">Veiculos</th>
                  <th className="text-right px-6 py-4 text-sm font-medium text-[#4D9F3F]">Acoes</th>
                </tr>
              </thead>
              <tbody>
                {loading ? (
                  <tr>
                    <td colSpan={5} className="text-center py-12 text-[#4D9F3F]">
                  ...
                  clientes.map((cliente) => (
                    <tr key={cliente.id} className="border-b border-[#AADF94]/50 hover:bg-[#daeece] transition-all duration-200 group">
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <span className="font-medium text-[#1a3a12]">{cliente.nome}</span>
                            {cliente.email && (
                              <p className="text-xs text-[#4D9F3F]">{cliente.email}</p>
                            )}
                          </div>
                        </div>
                      </td>
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-2 text-[#4D9F3F]">
                          <Phone size={14} className="text-[#22c55e]" />
                          {formatPhone(cliente.telefone)}
                        </div>
                      </td>
                      <td className="px-6 py-4">
                        <span className="text-[#4D9F3F]">
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center justify-end gap-1 p-1 bg-[#f0f8ea] rounded-lg ring-1 ring-[#AADF94] opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                          <button
                            onClick={() => {
                              window.open(`https://wa.me/55${cliente.telefone.replace(/\D/g, '')}`, '_blank');
                            }}
                            className="p-2 hover:bg-[#25D366]/10 rounded-md text-[#4D9F3F] hover:text-[#25D366] transition-all duration-200"
                            title="WhatsApp"
                          >
                          ...
                          <button
                            ...
                            className="p-2 hover:bg-blue-500/10 rounded-md text-[#4D9F3F] hover:text-blue-400 transition-all duration-200"
                            title="Ver detalhes"
                          >
                            <Eye size={16} />
                          </button>
                          <button
                            ...
                            className="p-2 hover:bg-[#daeece] rounded-md text-[#4D9F3F] hover:text-[#1a3a12] transition-all duration-200"
                            title="Editar"
                          >
                            <Edit size={16} />
                          </button>
                          <button
                            ...
                            className="p-2 hover:bg-red-500/10 rounded-md text-[#4D9F3F] hover:text-red-400 transition-all duration-200"
                            title="Excluir"
                          >
                            <Trash2 size={16} />
                          </button>
        ...
        <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-[#f0f8ea] border border-[#AADF94] rounded-2xl w-full max-w-md animate-fade-in shadow-2xl">
            <div className="p-6 border-b border-[#AADF94] flex items-center justify-between">
              <div>
                <h2 className="text-xl font-semibold text-[#1a3a12]">Novo Cliente</h2>
                <p className="text-sm text-[#4D9F3F] mt-1">Cadastre um novo cliente</p>
              </div>
            ...
            <div className="p-6 space-y-4 max-h-[60vh] overflow-y-auto">
              <div>
                <label className="block text-sm font-medium text-[#4D9F3F] mb-2">Nome *</label>
                <input
                  type="text"
                  value={form.nome}
                  onChange={(e) => setForm({ ...form, nome: e.target.value })}
                  placeholder="Nome completo"
                  className="w-full bg-[#daeece] border border-[#AADF94] rounded-xl px-4 py-3 text-[#1a3a12] placeholder-gray-500 focus:outline-none focus:border-[#22c55e]/50 focus:ring-1 focus:ring-[#22c55e]/20 transition-all duration-200"
                />
              </div>
              <div>
                <label className="block text-sm font-medium text-[#4D9F3F] mb-2">Telefone *</label>
                <input
                  type="text"
                  value={form.telefone}
              ...
              <div>
                <label className="block text-sm font-medium text-[#4D9F3F] mb-2">Email</label>
                <input
                  type="email"
                  value={form.email}
              ...
              <div>
                <label className="block text-sm font-medium text-[#4D9F3F] mb-2">CPF</label>
                <input
                  type="text"
                  value={form.cpf}
              ...
              {/* Endereco */}
              <div className="pt-2 border-t border-[#AADF94]">
                <label className="block text-sm font-medium text-[#4D9F3F] mb-3">Endereco</label>
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    <div className="col-span-1">
                      <input
                        ...
                        placeholder="CEP"
                        className="w-full bg-[#daeece] border border-[#AADF94] rounded-xl px-4 py-3 text-[#1a3a12] placeholder-gray-500 focus:outline-none focus:border-[#22c55e]/50 text-sm"
                      />
                    </div>
                    <div className="col-span-2">
                      <input
                        ...
                        className="w-full bg-[#daeece] border border-[#AADF94] rounded-xl px-4 py-3 text-[#1a3a12] placeholder-gray-500 focus:outline-none focus:border-[#22c55e]/50 text-sm disabled:opacity-50"
                      />
                    </div>
                  </div>
                  <div className="grid grid-cols-3 gap-3">
            ...
            <div className="p-6 border-t border-[#AADF94] flex gap-3 justify-end">
              <button
                ...
                className="px-6 py-3 border border-[#AADF94] rounded-xl text-[#4D9F3F] hover:bg-[#daeece] transition-all duration-200"
              >
                Cancelar
              </button>
              <button
                ...
                disabled={saving}
                className="px-6 py-3 bg-gradient-to-r from-[#22c55e] to-[#166534] rounded-xl text-white font-medium hover:shadow-lg hover:shadow-green-100 transition-all duration-300 disabled:opacity-50"
              >
      ...
      {showEditModal && selectedCliente && (
        <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-[#f0f8ea] border border-[#AADF94] rounded-2xl w-full max-w-md animate-fade-in shadow-2xl">
            <div className="p-6 border-b border-[#AADF94] flex items-center justify-between">
              <div>
                <h2 className="text-xl font-semibold text-[#1a3a12]">Editar Cliente</h2>
                <p className="text-sm text-[#4D9F3F] mt-1">Atualize as informacoes do cliente</p>
              </div>
          ...
          <div className="bg-[#f0f8ea] border border-[#AADF94] rounded-2xl w-full max-w-md animate-fade-in shadow-2xl">
            ...
            <div className="p-6">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  <p className="text-[#1a3a12] font-medium">{selectedCliente.nome}</p>
                  <p className="text-sm text-[#4D9F3F]">{formatPhone(selectedCliente.telefone)}</p>
                </div>
              </div>
          ...
          <div className="bg-[#f0f8ea] border border-[#AADF94] rounded-2xl w-full max-w-lg animate-fade-in max-h-[90vh] overflow-y-auto shadow-2xl">
            <div className="p-6 border-b border-[#AADF94] flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h2 className="text-xl font-semibold text-[#1a3a12]">{selectedCliente.nome}</h2>
                  <p className="text-sm text-[#4D9F3F]">Cliente #{selectedCliente.id}</p>
                </div>
              </div>
              <button onClick={() => setShowDetailModal(false)} className="p-2 hover:bg-[#daeece] rounded-lg text-[#4D9F3F] hover:text-[#1a3a12] transition-all duration-200">
                <X size={20} />
              </button>
            </div>
            <div className="p-6 space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div className="p-4 bg-[#daeece] rounded-xl border border-[#AADF94]">
                  <div className="flex items-center gap-2 text-[#4D9F3F] mb-1">
                    <Phone size={14} />
                    <span className="text-xs">Telefone</span>
                  </div>
                  <p className="text-[#1a3a12]">{formatPhone(selectedCliente.telefone)}</p>
                </div>
                <div className="p-4 bg-[#daeece] rounded-xl border border-[#AADF94]">
                  <div className="flex items-center gap-2 text-[#4D9F3F] mb-1">
                    <Car size={14} />
                  ...
                  <p className="text-[#1a3a12]">{selectedCliente.veiculosCount}</p>
                </div>
              </div>
              {selectedCliente.email && (
                <div className="p-4 bg-[#daeece] rounded-xl border border-[#AADF94]">
                  ...
                  <p className="text-[#1a3a12]">{selectedCliente.email}</p>
                </div>
              )}
              {selectedCliente.cpf && (
                <div className="p-4 bg-[#daeece] rounded-xl border border-[#AADF94]">
                  ...
                  <p className="text-[#1a3a12]">{formatCPF(selectedCliente.cpf)}</p>
                </div>
              )}
              {selectedCliente.endereco && (
                <div className="p-4 bg-[#daeece] rounded-xl border border-[#AADF94]">
                  ...
                  <p className="text-[#1a3a12]">{selectedCliente.endereco}</p>
                </div>
              )}
              ...
              {selectedCliente.veiculos && selectedCliente.veiculos.length > 0 && (
                <div>
                  <h3 className="text-sm font-medium text-[#4D9F3F] mb-3">Veiculos</h3>
                  <div className="space-y-2">
                    {selectedCliente.veiculos.map((veiculo) => (
                      <div key={veiculo.id} className="p-4 bg-[#daeece] rounded-xl border border-[#AADF94] flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          <div className="p-2 bg-blue-500/10 rounded-lg ring-1 ring-blue-500/20">
                            <Car size={16} className="text-blue-400" />
                          </div>
                          <div>
                            <p className="text-[#1a3a12]">{veiculo.marca} {veiculo.modelo}</p>
