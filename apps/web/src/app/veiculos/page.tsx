      ...
      <div className="p-6 space-y-6 animate-fade-in">
          ...
          <div className="group relative bg-[#f2f4ee] rounded-2xl p-5 border border-[#b8c4a8] hover:border-green-300 transition-all duration-300 hover:shadow-lg hover:shadow-[#4A701C]/5">
            ...
            <div className="relative flex items-center gap-3">
              <div className="p-3 bg-gradient-to-br from-[#4A701C]/20 to-[#4A701C]/5 rounded-xl ring-1 ring-[#4A701C]/20">
                <Car size={20} className="text-[#4A701C]" />
              </div>
              <div>
                <p className="text-2xl font-bold text-[#284703]">{veiculos.length}</p>
                <p className="text-xs text-[#555D4C]">Total Veículos</p>
              </div>
            </div>
          </div>
          <div className="group relative bg-[#f2f4ee] rounded-2xl p-5 border border-[#b8c4a8] hover:border-blue-500/30 transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/5">
            ...
            <div className="relative flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-[#555D4C]">Clientes</p>
              </div>
            </div>
          </div>
          <div className="group relative bg-[#f2f4ee] rounded-2xl p-5 border border-[#b8c4a8] hover:border-amber-500/30 transition-all duration-300 hover:shadow-lg hover:shadow-amber-500/5 hidden md:block">
            ...
            <div className="relative flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-[#555D4C]">O.S. Abertas</p>
              </div>
            </div>
          </div>
        </div>
        ...
        {loading ? (
          ...
          <div className="bg-[#f2f4ee] border border-[#b8c4a8] rounded-2xl p-12 text-center">
            ...
            <p className="text-[#555D4C]">Nenhum veículo encontrado</p>
            <p className="text-sm text-[#88B257] mt-1">Cadastre o primeiro veículo clicando no botão acima</p>
          </div>
        ) : (
              ...
              <div key={veiculo.id} className="group bg-[#f2f4ee] border border-[#b8c4a8] rounded-2xl p-5 hover:border-green-300 transition-all duration-300 hover:shadow-lg hover:shadow-[#4A701C]/5">
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="font-bold text-[#284703]">{veiculo.marca} {veiculo.modelo}</h3>
                      <p className="text-sm text-[#555D4C]">{veiculo.ano || 'Ano não informado'}</p>
                    </div>
                  </div>
                  <span className="px-3 py-1.5 bg-[#4A701C]/10 text-[#4A701C] rounded-lg text-sm font-mono font-bold ring-1 ring-[#4A701C]/20">
                    {formatPlate(veiculo.placa)}
                  </span>
                </div>

                <div className="space-y-3 mb-4">
                  <div className="flex items-center justify-between text-sm p-2 rounded-lg bg-[#e8ece2]">
                    <span className="text-[#555D4C] flex items-center gap-2">
                      <User size={14} /> Proprietário
                    </span>
                    <span className="text-[#284703]">{veiculo.cliente.nome}</span>
                  </div>
                  {veiculo.kmAtual && (
                    <div className="flex items-center justify-between text-sm p-2 rounded-lg bg-[#e8ece2]">
                      <span className="text-[#555D4C] flex items-center gap-2">
                      ...
                      <span className="text-[#284703]">{veiculo.kmAtual.toLocaleString('pt-BR')} km</span>
                    </div>
                  )}
                  {veiculo.cor && (
                    <div className="flex items-center justify-between text-sm p-2 rounded-lg bg-[#e8ece2]">
                      <span className="text-[#555D4C]">Cor</span>
                      <span className="text-[#284703]">{veiculo.cor}</span>
                    </div>
                  )}
                </div>
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="flex-1 flex items-center justify-center gap-2 py-2.5 bg-gradient-to-r from-[#4A701C] to-[#284703] rounded-xl text-white text-sm font-medium hover:shadow-lg hover:shadow-green-100 transition-all duration-300"
                  >
                    <ClipboardList size={16} />
                    Nova O.S.
                  </button>
                  <div className="flex gap-1 p-1 bg-[#e8ece2] rounded-xl ring-1 ring-[#b8c4a8]">
                    <button
                      onClick={() => openEditModal(veiculo)}
                      className="p-2 hover:bg-[#e8ece2] rounded-lg text-[#555D4C] hover:text-[#284703] transition-all duration-200"
                      title="Editar"
                    >
                      <Edit size={16} />
                    </button>
                    <button
                      ...
                      className="p-2 hover:bg-red-500/10 rounded-lg text-[#555D4C] hover:text-red-400 transition-all duration-200"
                      title="Excluir"
                    >
                      <Trash2 size={16} />
                    </button>
          ...
          <div className="bg-[#f2f4ee] border border-[#b8c4a8] rounded-2xl w-full max-w-md animate-fade-in max-h-[90vh] overflow-y-auto shadow-2xl">
            <div className="p-6 border-b border-[#b8c4a8] flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-[#555D4C] mt-1">Cadastre um novo veículo</p>
              </div>
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 bg-[#e8ece2] border border-[#b8c4a8] rounded-xl px-4 py-3 text-[#284703] placeholder-[#88B257] focus:outline-none focus:border-[#4A701C]/50 focus:ring-1 focus:ring-[#4A701C]/20 uppercase font-mono transition-all duration-200"
                  />
                  <button
                    type="button"
                    onClick={() => setShowOCR(true)}
                    className="px-4 py-3 bg-gradient-to-r from-[#4A701C] to-[#284703] rounded-xl text-white hover:shadow-lg hover:shadow-green-100 transition-all duration-300"
            ...
            <div className="p-6 border-t border-[#b8c4a8] flex gap-3 justify-end">
              <button
                ...
                className="px-6 py-3 border border-[#b8c4a8] rounded-xl text-[#94a3b8] hover:bg-[#e8ece2] transition-all duration-200"
              >
                Cancelar
              </button>
              <button
          ...
          <div className="bg-[#f2f4ee] border border-[#b8c4a8] rounded-2xl w-full max-w-md animate-fade-in max-h-[90vh] overflow-y-auto shadow-2xl">
            <div className="p-6 border-b border-[#b8c4a8] flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-[#555D4C] mt-1">Atualize as informações do veículo</p>
              </div>
            ...
            <div className="p-6 space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  value={form.placa}
                  onChange={(e) => setForm({ ...form, placa: e.target.value.toUpperCase() })}
                  className="w-full bg-[#e8ece2] border border-[#b8c4a8] rounded-xl px-4 py-3 text-[#284703] focus:outline-none focus:border-[#4A701C]/50 focus:ring-1 focus:ring-[#4A701C]/20 uppercase font-mono transition-all duration-200"
                />
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div>
          ...
          <div className="bg-[#f2f4ee] border border-[#b8c4a8] rounded-2xl w-full max-w-md animate-fade-in shadow-2xl">
            ...
            <div className="p-6">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  <p className="text-[#284703] font-medium">{selectedVeiculo.marca} {selectedVeiculo.modelo}</p>
                  <p className="text-sm text-[#4A701C] font-mono">{selectedVeiculo.placa}</p>
                </div>
              </div>
