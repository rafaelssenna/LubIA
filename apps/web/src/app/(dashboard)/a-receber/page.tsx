      ...
      <main className="p-3 sm:p-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 sm:gap-4 mb-6">
            <div className="bg-gradient-to-br from-amber-500/10 to-amber-600/5 border border-amber-500/20 rounded-2xl p-3 sm:p-5">
            ...
            <div className="bg-gradient-to-br from-purple-500/10 to-purple-600/5 border border-purple-500/20 rounded-2xl p-3 sm:p-5">
              <div className="flex items-center justify-between">
                <div>
            ...
            <div className="bg-gradient-to-br from-blue-500/10 to-blue-600/5 border border-blue-500/20 rounded-2xl p-3 sm:p-5">
              <div className="flex items-center justify-between">
                <div>
            ...
            <div className="flex flex-wrap gap-2">
              {[
                ...
                <button
                  ...
                  className={`px-4 py-3 min-h-[44px] rounded-xl border transition-all duration-200 ${
            ...
            <div className="space-y-3">
              {filteredPendencias.map((pendencia) => (
                <div
                  ...
                  className="bg-card border border-border rounded-xl p-3 sm:p-4 hover:border-border transition-all duration-200"
                >
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                    ...
                    <div className="flex items-center justify-between sm:justify-end gap-4 sm:gap-6">
                      <div className="text-left sm:text-right">
                        <p className="text-base sm:text-lg font-bold text-amber-400">{formatCurrency(pendencia.total)}</p>
                      ...
                      <button
                        ...
                        className="px-4 py-2 min-h-[44px] bg-gradient-to-r from-emerald-500 to-emerald-700 rounded-xl text-white text-sm font-medium hover:shadow-lg hover:shadow-emerald-500/25 transition-all duration-300"
                      >
                        Receber
                      </button>
                    </div>
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-card border border-border rounded-2xl w-full max-w-md shadow-2xl shadow-black/50 max-h-[90vh] overflow-y-auto">
            <div className="p-3 sm:p-6 border-b border-border flex items-center justify-between">
              <h2 className="text-lg sm:text-xl font-semibold text-foreground">Registrar Pagamento</h2>
              <button
                onClick={() => {
                  setShowPagamentoModal(false);
                  setSelectedPendencia(null);
            ...
            <div className="p-3 sm:p-6">
              ...
              <div className="bg-background rounded-xl p-3 sm:p-4 mb-4 sm:mb-6">
                <div className="flex justify-between items-center">
                  <span className="text-muted">Valor a receber:</span>
                  <span className="text-xl sm:text-2xl font-bold text-emerald-400">{formatCurrency(selectedPendencia.total)}</span>
                </div>
              </div>
            ...
            <div className="p-3 sm:p-6 border-t border-border flex flex-col sm:flex-row gap-3 justify-end">
              <button
                onClick={() => {
                  setShowPagamentoModal(false);
                  setSelectedPendencia(null);
              ...
              <button
                ...
                className="px-6 py-3 min-h-[44px] bg-gradient-to-r from-emerald-500 to-emerald-700 rounded-xl text-white font-medium hover:shadow-lg hover:shadow-emerald-500/25 transition-all duration-300 disabled:opacity-50"
              >
                {saving ? (
