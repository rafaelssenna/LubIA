  ...
  return (
    <div className="min-h-screen bg-[#000000]">
      ...
      <div className="p-6 space-y-6 animate-fade-in">
        {/* Info Card */}
        <div className="bg-gradient-to-r from-[#22c55e]/10 to-[#166534]/10 border border-[#22c55e]/30 rounded-2xl p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {configSections.map((section) => {
            ...
            return (
              <button
                key={section.id}
                className="bg-[#1F1F1F] border border-[#333333] rounded-2xl p-6 text-left hover:border-[#22c55e]/50 transition-colors group"
              >
        ...
        <div className="bg-[#1F1F1F] border border-[#333333] rounded-2xl p-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className="p-3 bg-[#333333] rounded-xl">
            ...
            <span className="px-3 py-1 bg-[#22c55e]/20 text-[#22c55e] text-xs font-medium rounded-full">
              Atualizado
            </span>
          </div>
        </div>
        ...
        <div className="bg-[#1F1F1F] border border-[#333333] rounded-2xl p-6">
          ...
          <div className="flex flex-wrap gap-3">
            <button className="px-4 py-2 bg-[#333333] hover:bg-[#444444] rounded-xl text-sm text-[#94a3b8] hover:text-white transition-colors">
              Exportar Dados
            </button>
            <button className="px-4 py-2 bg-[#333333] hover:bg-[#444444] rounded-xl text-sm text-[#94a3b8] hover:text-white transition-colors">
              Limpar Cache
