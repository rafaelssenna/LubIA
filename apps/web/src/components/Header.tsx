...
export default function Header({ title, subtitle }: HeaderProps) {
  ...
  return (
    <header className="glass border-b border-gray-200 px-8 py-5">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="relative group">
            ...
            <input
              ...
              className="bg-gray-50 border border-gray-200 rounded-2xl pl-11 pr-4 py-3 w-80 text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:border-[#22c55e]/50 focus:bg-white transition-all duration-300 focus:shadow-lg focus:shadow-[#22c55e]/10"
            />
          </div>
          ...
          <div className="relative">
            <button
              ...
              className="relative p-3 rounded-2xl bg-gray-50 border border-gray-200 hover:border-[#22c55e]/50 hover:bg-green-50 transition-all duration-300 group"
            >
              ...
              <div className="absolute right-0 top-full mt-3 w-96 glass-card rounded-2xl shadow-2xl z-50 animate-fade-in overflow-hidden">
                ...
                <div className="max-h-80 overflow-y-auto custom-scrollbar">
                  {notifications.map((notif, index) => (
                    <div
                      key={notif.id}
                      className={`p-4 border-b border-gray-100 hover:bg-gray-50 cursor-pointer transition-all duration-300 border-l-2 ${getTypeColor(notif.type)}`}
          ...
          <div className="relative">
            <button
              ...
              className="flex items-center gap-3 p-2 pr-4 rounded-2xl bg-gray-50 border border-gray-200 hover:border-[#22c55e]/50 hover:bg-green-50 transition-all duration-300 group"
            >
            ...
            {showProfile && (
              <div className="absolute right-0 top-full mt-3 w-56 glass-card rounded-2xl shadow-2xl z-50 animate-fade-in overflow-hidden">
                <div className="p-2">
                  <button className="w-full text-left px-4 py-3 text-sm text-gray-500 hover:bg-gray-50 hover:text-gray-900 rounded-xl transition-all duration-300 flex items-center gap-3">
                    <User size={16} />
                    Meu Perfil
                  </button>
                  <button className="w-full text-left px-4 py-3 text-sm text-gray-500 hover:bg-gray-50 hover:text-gray-900 rounded-xl transition-all duration-300 flex items-center gap-3">
